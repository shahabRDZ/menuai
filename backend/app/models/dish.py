...
class Dish(Base):
    ...
    typical_price_min: Mapped[float | None] = mapped_column(Numeric(10, 2))
    typical_price_max: Mapped[float | None] = mapped_column(Numeric(10, 2))
    price_fairness: Mapped[str | None] = mapped_column(String(20))
    price_delta_percent: Mapped[int | None] = mapped_column(Integer)
    price_estimate_confidence: Mapped[str | None] = mapped_column(String(10))
